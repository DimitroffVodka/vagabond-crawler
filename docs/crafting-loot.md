...
- **Still up to the GM:** movement powers (Flying, Climbing, Jumping…), Telepathy, Detection, Sense Valuables, Ambassador, Aqua-Lung, Warning, and the once-per-day / once-ever powers (Blasting, Precision, After-Image, Wish-granting, Benediction, Store Spell).
